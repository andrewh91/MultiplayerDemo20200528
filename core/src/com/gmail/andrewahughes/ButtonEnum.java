...
public class ButtonEnum {
    ...
    */
    enum Tri {
        ...
        TRIDENTBUILDINGAUTOBUILD            (10),
        TRIDENTBUILDINGSPEARMED             (11),
        TRIDENTBUILDINGSPEARLOW             (12),
        TRIDENTBUILDINGBIDENTMED            (13),
        TRIDENTBUILDINGBIDENTLOW            (14),
        TRIDENTBUILDINGTRIDENTHI            (15),
        TRIDENTBUILDINGTRIDENTMED           (16),
        TRIDENTBUILDINGTRIDENTLOW           (17),
        TRIDENTBUILDINGSUIT0NATURE          (18),
        TRIDENTBUILDINGSUIT1LIGHT           (19),
        TRIDENTBUILDINGSUIT2DEMON           (20),
        TRIDENTBUILDINGSUIT3DARK            (21),
        TRIDENTBUILDINGSUIT4ANY             (22),
        TRIDENTBUILDINGAUTOBUILDROTATE      (23),
        TRIDENTBUILDINGAUTOBUILDFLIP        (24),
        TRIDENTBUILDINGAUTOBUILDCONFIRM     (25),
